...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        public static Flight flight1 = new Flight
        {
            ...
            Destination = "Paris",
            EffectiveArriaval = new DateTime(2022, 01, 01, 17, 10, 10),
...
traveller3, traveller4, traveller5 }
        ...
        10),
            Destination = "Paris",
            EffectiveArriaval = new DateTime(2022, 02, 01, 23, 10, 10),
        ...
        10),
            Destination = "Paris",
            EffectiveArriaval = new DateTime(2022, 03, 01, 6, 40, 10),
        ...
        10),
            Destination = "Madrid",
            EffectiveArriaval = new DateTime(2022, 04, 01, 8, 10, 10),
        ...
        10),
            Destination = "Madrid",
            EffectiveArriaval = new DateTime(2022, 05, 01, 18, 50, 10),
            EstimatedDuration = 105,
            Plane = BoingPlane
        };
        ...
        10),
            ...
            EffectiveArriaval = new DateTime(2022, 06, 01, 22, 30, 10),
